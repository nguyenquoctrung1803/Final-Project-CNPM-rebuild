...
Values(N'" + ex.MaHDBH + "',N'" + ex.MaKH + "',N'" + ex.MaNV + "','" + ex.NgayLapHDBH + "'," + ex.TongTien + ",N'" + ex.TrangThai + "')");
        ...
        {
            KetNoi.ExecuteReader(@"insert into CT_HoaDonBanHang(MaHDBH,MaLK,SoLuong,DonGia,KhuyenMai,ThanhTien,TrangThai,TrangThaiTToan,TrangThaiVChuyen)
values(N'" + exx.MaHDBH + "',N'" + exx.MaLK + "'," + exx.SoLuong + "," + exx.DonGia + "," + exx.KhuyenMai + "," + exx.ThanhTien + ",'" + exx.TrangThai + "',N'" + exx.TrangThaiTToan + "',N'" + exx.TrangThaiVChuyen + "')");
        }
