...
namespace Final_Project
{
    public partial class Frm_HoaDonBanHang : Form
    {
        ...
        {
            dataGridViewCTHD.DataSource = bus.GetCtHoaDon("select LinhKien.TenLK,CT_HoaDonBanHang.SoLuong,CT_HoaDonBanHang.DonGia,KhuyenMai,ThanhTien,TrangThaiTToan, TrangThaiVChuyen from CT_HoaDonBanHang ,LinhKien Where LinhKien.MaLK=CT_HoaDonBanHang.MaLK and CT_HoaDonBanHang.MaHDBH=N'" + txtMaHD.Text + "'");
        }

        public void HienThiCTHD_TheoMaHD(string condition)
        {
            dataGridViewCTHD.DataSource = bus.HienThiCTHDTheoMa("select lk.TenLK,ct.SoLuong,ct.DonGia,ct.KhuyenMai,ct.ThanhTien, ct.TrangThaiTToan, ct.TrangThaiVChuyen From CT_HoaDonBanHang ct,LinhKien lk where lk.MaLK=ct.MaLK and ct.MaHDBH=N'" + condition + "'");
        }
        ...
        {
            dataGridViewCTHD.DataSource = bus.GetCtHoaDon("select LinhKien.MaLK, LinhKien.TenLK,CT_HoaDonBanHang.SoLuong,CT_HoaDonBanHang.DonGia,CT_HoaDonBanHang.KhuyenMai,ThanhTien, CT_HoaDonBanHang.TrangThaiTToan, CT_HoaDonBanHang.TrangThaiVChuyen from CT_HoaDonBanHang ,LinhKien Where LinhKien.MaLK=CT_HoaDonBanHang.MaLK and CT_HoaDonBanHang.MaHDBH=N'" + txtMaHD.Text + "'");
        }
        ...
        {
            dataGridViewCTHD.DataSource = bus.GetCtHoaDon("select LinhKien.MaLK, LinhKien.TenLK,CT_HoaDonBanHang.SoLuong,CT_HoaDonBanHang.DonGia,CT_HoaDonBanHang.KhuyenMai,ThanhTien, CT_HoaDonBanHang.TrangThaiTToan, CT_HoaDonBanHang.TrangThaiVChuyen from CT_HoaDonBanHang ,LinhKien Where LinhKien.MaLK=CT_HoaDonBanHang.MaLK and CT_HoaDonBanHang.MaHDBH=N'" + txtMaHD.Text + "' and CT_HoaDonBanHang.TrangThai=N'1'");
        }
        ...
        public void HienThiCTHoaDonTextBox(int vitri, DataTable d)
        {
            try
            {
                ...
                textBox1.Text = d.Rows[vitri]["TenLK"].ToString();
                textBox2.Text = d.Rows[vitri]["TenLK"].ToString();
            }
            catch
            {
        ...
        private void dataGridViewCTHD_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            textBox1.Text = row.Cells["TrangThaiTToan"].Value.ToString();
            textBox2.Text = row.Cells["TrangThaiVChuyen"].Value.ToString();
        }
        ...
        {            
            ...
            for (int i = 0; i < dataGridViewCTHD.Rows.Count - 0; i++)
            {
                CT_HoaDon cT_HoaDon = new CT_HoaDon
                {
                    ...
                    TrangThaiTToan = dataGridViewCTHD.Rows[i].Cells["TrangThaiTToan"].Value.ToString(),
                    TrangThaiVChuyen = dataGridViewCTHD.Rows[i].Cells["TrangThaiVChuyen"].Value.ToString(),
            ...
            frm_in.reportViewer1.LocalReport.ReportEmbeddedResource = "Final_Project.reportbc.rdlc";         
